  ...
  return (
    <Q1>
      ...
      <Component13>
        ...
        <InputField type='email' placeholder='  가게 이름을 입력해주세요'></InputField>
      </Component13>
      <Component14>
        <Rectangle261>
        </Rectangle261>
        ...
        <InputField type='email' placeholder='  가게 연락처를 입력해주세요'></InputField>
      </Component14>
      <Component15>
        <Rectangle262>
        </Rectangle262>
        ...
        <InputField type='text' placeholder='  가게를 간단하게 소개해 주세요'></InputField>
      </Component15>
      <Component16>
        <Rectangle263>
        </Rectangle263>
        ...
        <InputField type='text' placeholder='  가게 도로명 주소를 입력해 주세요'></InputField>
      </Component16>
      <Component17>
        <Rectangle264>
        </Rectangle264>
        ...
        <InputField type='text' placeholder='  가게 상세 주소를 입력해 주세요'></InputField>
      </Component17>
      <Component18>
        <Rectangle265>
        </Rectangle265>
        ...
        <InputField type='text' placeholder='  영업시작시간을 입력해 주세요'></InputField>
      </Component18>
      <Component19>
        <Rectangle266>
        </Rectangle266>
        ...
        <InputField type='text' placeholder='  영업종료시간을 입력해 주세요'></InputField>
      </Component19>
    </Q1>);
